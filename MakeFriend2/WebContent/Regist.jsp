				...
				<div class="col-md-6 col-md-offset-3">
					...
					<form class="form-horizontal" action="regist" method="post">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control"   id="inputloginName" name="card" placeholder="请输入身份证号">
					    </div>
					  </div>
					 ...
					 <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control"  name="email"  id="inputEmail3" placeholder="邮箱">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control"  name="tel"  id="inputEmail3" placeholder="电话">
					    </div>
					  </div>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control"  name="job"  id="inputEmail3" placeholder="输入您的职业">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">					    	
						<input id="rg" type="range" name="heigh" min="150" max="200" value="170" />
						<label id="lb" >170</label>公分
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input id="wg" type="range" name="weight" min="50" max="100" value="70" />
						<label id="wb" >70</label>公斤
					    </div>
					  </div>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-8">
							省 <select id="province" name="province"></select> 市 <select id="city" name="city"></select> 区 <select id="qu" name="qu"></select>
						</div>
					  	</div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-8">
					      <input type="textarea" name="intruct" class="form-control" id="inputPassword3" placeholder="请输入您的交友宣言">
					    </div>
					  </div>
